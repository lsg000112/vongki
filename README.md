...
코로나19와 봉사활동의 대입 미반영 등의 여파로 MZ세대를 비롯한 봉사활동 참여율이 급감했습니다.<br>
...
- 누적 마일리지에 따라 봉키 성장(각각 6단계 성장으로 총 18단계 제공)
- 마일리지를 소모하여 인테리어 소품(지붕, 벽, 벽지, 창문, 의자, 시계, 화분, 커튼; 카테고리 별 3~6종류) 총 42종 구매 가능

### 봉사 활동 인증에 따른 마일리지 지급

- 1365 봉사 활동서 캡쳐 후 파일 업로드 시 구글 MLkit의 OCR을 통해 텍스트 인식, 인식 후 1365 서버에서 해당 데이터로 조회하고 파싱하여 대조, 유효성이 확인되면 마일리지 지급
- 중복된 활동서는 인증이 거부됨
